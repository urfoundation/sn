...
func (sTSubnet *STSubnet) UnpackError(raw []byte) (any, error) {
	...
	if bytes.Equal(raw[:4], sTSubnet.abi.Errors["SafeCastOverflowedUintDowncast"].ID.Bytes()[:4]) {
		return sTSubnet.UnpackSafeCastOverflowedUintDowncastError(raw[4:])
	}
...
// STSubnetSafeCastOverflowedUintDowncast represents a SafeCastOverflowedUintDowncast error raised by the STSubnet contract.
type STSubnetSafeCastOverflowedUintDowncast struct {
	Bits  uint8
	Value *big.Int
}
...
func STSubnetSafeCastOverflowedUintDowncastErrorID() common.Hash {
...
//
// Solidity: error SafeCastOverflowedUintDowncast(uint8 bits, uint256 value)
func (sTSubnet *STSubnet) UnpackSafeCastOverflowedUintDowncastError(raw []byte) (*STSubnetSafeCastOverflowedUintDowncast, error) {
	out := new(STSubnetSafeCastOverflowedUintDowncast)
	if err := sTSubnet.abi.UnpackIntoInterface(out, "SafeCastOverflowedUintDowncast", raw); err != nil {
		return nil, err
	}
	return out, nil
}
