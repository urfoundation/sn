...
// the contract method with ID 0xffb053e9.  This method will panic if any
// invalid/nil inputs are passed.
//
// Solidity: function registerEscrow() payable returns(uint16 uid)
func (sTSettlementVault *STSettlementVault) PackRegisterEscrow() []byte {
	enc, err := sTSettlementVault.abi.Pack("registerEscrow")
	if err != nil {
		panic(err)
	}
	return enc
...
// the contract method with ID 0xffb053e9.  This method will return an error
// if any inputs are invalid/nil.
//
// Solidity: function registerEscrow() payable returns(uint16 uid)
func (sTSettlementVault *STSettlementVault) TryPackRegisterEscrow() ([]byte, error) {
	return sTSettlementVault.abi.Pack("registerEscrow")
}

// UnpackRegisterEscrow is the Go binding that unpacks the parameters returned
// from invoking the contract method with ID 0xffb053e9.
//
// Solidity: function registerEscrow() payable returns(uint16 uid)
...
// the contract method with ID 0x7980602b.  This method will panic if any
// invalid/nil inputs are passed.
//
// Solidity: function registerPool(uint256 noId, bytes32 poolHotkey) payable returns(uint16 uid)
func (sTSettlementVault *STSettlementVault) PackRegisterPool(noId *big.Int, poolHotkey [32]byte) []byte {
	enc, err := sTSettlementVault.abi.Pack("registerPool", noId, poolHotkey)
	if err != nil {
		panic(err)
	}
	return enc
...
// the contract method with ID 0x7980602b.  This method will return an error
// if any inputs are invalid/nil.
//
// Solidity: function registerPool(uint256 noId, bytes32 poolHotkey) payable returns(uint16 uid)
func (sTSettlementVault *STSettlementVault) TryPackRegisterPool(noId *big.Int, poolHotkey [32]byte) ([]byte, error) {
	return sTSettlementVault.abi.Pack("registerPool", noId, poolHotkey)
}

// UnpackRegisterPool is the Go binding that unpacks the parameters returned
// from invoking the contract method with ID 0x7980602b.
//
// Solidity: function registerPool(uint256 noId, bytes32 poolHotkey) payable returns(uint16 uid)
