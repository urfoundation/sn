...
// PackRESERVEROUNDINGALLOWANCERAO is the Go binding used to pack the parameters required for calling
// the contract method with ID 0x03438d78.  This method will panic if any
// invalid/nil inputs are passed.
//
// Solidity: function RESERVE_ROUNDING_ALLOWANCE_RAO() view returns(uint256)
func (sTCoordinator *STCoordinator) PackRESERVEROUNDINGALLOWANCERAO() []byte {
	enc, err := sTCoordinator.abi.Pack("RESERVE_ROUNDING_ALLOWANCE_RAO")
	if err != nil {
		panic(err)
	}
	return enc
...
// TryPackRESERVEROUNDINGALLOWANCERAO is the Go binding used to pack the parameters required for calling
// the contract method with ID 0x03438d78.  This method will return an error
// if any inputs are invalid/nil.
//
// Solidity: function RESERVE_ROUNDING_ALLOWANCE_RAO() view returns(uint256)
func (sTCoordinator *STCoordinator) TryPackRESERVEROUNDINGALLOWANCERAO() ([]byte, error) {
	return sTCoordinator.abi.Pack("RESERVE_ROUNDING_ALLOWANCE_RAO")
}

// UnpackRESERVEROUNDINGALLOWANCERAO is the Go binding that unpacks the parameters returned
// from invoking the contract method with ID 0x03438d78.
//
// Solidity: function RESERVE_ROUNDING_ALLOWANCE_RAO() view returns(uint256)
func (sTCoordinator *STCoordinator) UnpackRESERVEROUNDINGALLOWANCERAO(data []byte) (*big.Int, error) {
	out, err := sTCoordinator.abi.Unpack("RESERVE_ROUNDING_ALLOWANCE_RAO", data)
	if err != nil {
		return new(big.Int), err
	}
	out0 := abi.ConvertType(out[0], new(big.Int)).(*big.Int)
...
// PackRUNTIMESHAREROUNDINGALLOWANCERAO is the Go binding used to pack the parameters required for calling
// the contract method with ID 0xa43226ab.  This method will panic if any
// invalid/nil inputs are passed.
//
// Solidity: function RUNTIME_SHARE_ROUNDING_ALLOWANCE_RAO() view returns(uint256)
func (sTCoordinator *STCoordinator) PackRUNTIMESHAREROUNDINGALLOWANCERAO() []byte {
	enc, err := sTCoordinator.abi.Pack("RUNTIME_SHARE_ROUNDING_ALLOWANCE_RAO")
	if err != nil {
		panic(err)
	}
	return enc
...
// TryPackRUNTIMESHAREROUNDINGALLOWANCERAO is the Go binding used to pack the parameters required for calling
// the contract method with ID 0xa43226ab.  This method will return an error
// if any inputs are invalid/nil.
//
// Solidity: function RUNTIME_SHARE_ROUNDING_ALLOWANCE_RAO() view returns(uint256)
func (sTCoordinator *STCoordinator) TryPackRUNTIMESHAREROUNDINGALLOWANCERAO() ([]byte, error) {
	return sTCoordinator.abi.Pack("RUNTIME_SHARE_ROUNDING_ALLOWANCE_RAO")
}

// UnpackRUNTIMESHAREROUNDINGALLOWANCERAO is the Go binding that unpacks the parameters returned
// from invoking the contract method with ID 0xa43226ab.
//
// Solidity: function RUNTIME_SHARE_ROUNDING_ALLOWANCE_RAO() view returns(uint256)
func (sTCoordinator *STCoordinator) UnpackRUNTIMESHAREROUNDINGALLOWANCERAO(data []byte) (*big.Int, error) {
	out, err := sTCoordinator.abi.Unpack("RUNTIME_SHARE_ROUNDING_ALLOWANCE_RAO", data)
	if err != nil {
		return new(big.Int), err
	}
	out0 := abi.ConvertType(out[0], new(big.Int)).(*big.Int)
...
// PackFixValidatorEvidence is the Go binding used to pack the parameters required for calling
// the contract method with ID 0x4c39f5fc.  This method will panic if any
// invalid/nil inputs are passed.
//
// Solidity: function fixValidatorEvidence(address evidence) returns()
func (sTCoordinator *STCoordinator) PackFixValidatorEvidence(evidence common.Address) []byte {
	enc, err := sTCoordinator.abi.Pack("fixValidatorEvidence", evidence)
	if err != nil {
		panic(err)
	}
	return enc
...
// TryPackFixValidatorEvidence is the Go binding used to pack the parameters required for calling
// the contract method with ID 0x4c39f5fc.  This method will return an error
// if any inputs are invalid/nil.
//
// Solidity: function fixValidatorEvidence(address evidence) returns()
func (sTCoordinator *STCoordinator) TryPackFixValidatorEvidence(evidence common.Address) ([]byte, error) {
	return sTCoordinator.abi.Pack("fixValidatorEvidence", evidence)
}
...
// PackValidatorEvidence is the Go binding used to pack the parameters required for calling
// the contract method with ID 0xe8204a13.  This method will panic if any
// invalid/nil inputs are passed.
//
// Solidity: function validatorEvidence() view returns(address)
func (sTCoordinator *STCoordinator) PackValidatorEvidence() []byte {
	enc, err := sTCoordinator.abi.Pack("validatorEvidence")
	if err != nil {
		panic(err)
	}
	return enc
...
// TryPackValidatorEvidence is the Go binding used to pack the parameters required for calling
// the contract method with ID 0xe8204a13.  This method will return an error
// if any inputs are invalid/nil.
//
// Solidity: function validatorEvidence() view returns(address)
func (sTCoordinator *STCoordinator) TryPackValidatorEvidence() ([]byte, error) {
	return sTCoordinator.abi.Pack("validatorEvidence")
}

// UnpackValidatorEvidence is the Go binding that unpacks the parameters returned
// from invoking the contract method with ID 0xe8204a13.
//
// Solidity: function validatorEvidence() view returns(address)
func (sTCoordinator *STCoordinator) UnpackValidatorEvidence(data []byte) (common.Address, error) {
	out, err := sTCoordinator.abi.Unpack("validatorEvidence", data)
	if err != nil {
		return *new(common.Address), err
	}
	out0 := *abi.ConvertType(out[0], new(common.Address)).(*common.Address)
...
// STCoordinatorValidatorEvidenceFixed represents a ValidatorEvidenceFixed event raised by the STCoordinator contract.
type STCoordinatorValidatorEvidenceFixed struct {
	Evidence common.Address
	Raw      *types.Log // Blockchain specific contextual infos
}

const STCoordinatorValidatorEvidenceFixedEventName = "ValidatorEvidenceFixed"

// ContractEventName returns the user-defined event name.
func (STCoordinatorValidatorEvidenceFixed) ContractEventName() string {
	return STCoordinatorValidatorEvidenceFixedEventName
}

// UnpackValidatorEvidenceFixedEvent is the Go binding that unpacks the event data emitted
// by contract.
//
// Solidity: event ValidatorEvidenceFixed(address indexed evidence)
func (sTCoordinator *STCoordinator) UnpackValidatorEvidenceFixedEvent(log *types.Log) (*STCoordinatorValidatorEvidenceFixed, error) {
	event := "ValidatorEvidenceFixed"
	if len(log.Topics) == 0 || log.Topics[0] != sTCoordinator.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(STCoordinatorValidatorEvidenceFixed)
	if len(log.Data) > 0 {
		if err := sTCoordinator.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
func (sTCoordinator *STCoordinator) UnpackError(raw []byte) (any, error) {
	...
	if bytes.Equal(raw[:4], sTCoordinator.abi.Errors["RuntimeAccountingMismatch"].ID.Bytes()[:4]) {
		return sTCoordinator.UnpackRuntimeAccountingMismatchError(raw[4:])
	}
...
// STCoordinatorRuntimeAccountingMismatch represents a RuntimeAccountingMismatch error raised by the STCoordinator contract.
type STCoordinatorRuntimeAccountingMismatch struct {
}

// ErrorID returns the hash of canonical representation of the error's signature.
//
// Solidity: error RuntimeAccountingMismatch()
func STCoordinatorRuntimeAccountingMismatchErrorID() common.Hash {
...
//
// Solidity: error RuntimeAccountingMismatch()
func (sTCoordinator *STCoordinator) UnpackRuntimeAccountingMismatchError(raw []byte) (*STCoordinatorRuntimeAccountingMismatch, error) {
	out := new(STCoordinatorRuntimeAccountingMismatch)
	if err := sTCoordinator.abi.UnpackIntoInterface(out, "RuntimeAccountingMismatch", raw); err != nil {
		return nil, err
	}
	return out, nil
}
