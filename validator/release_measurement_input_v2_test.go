...
func TestReleaseMeasurementInputV2RuntimeRestartsExactGenuineInput(t *testing.T) {
	...
	if input.AttemptCutV2 == nil || input.AttemptCutV2.RecordCount != 8 || input.AttemptCutV2.CompleteCount != 1 || input.Stats.AttemptCut != nil || input.Stats.SettlementTransition != nil || input.EgressGeneration != 1 || fixture.runtime.stats.egressGeneration != 2 {
	...
	if err != nil || !os.SameFile(info, current) || !bytes.Equal(before, after) || !reflect.DeepEqual(restarted, input) || fixture.runtime.objects.writes != writes || fixture.runtime.objects.reads <= reads || fixture.runtime.stats.egressGeneration != 2 {
...
func TestReleaseMeasurementInputV2RuntimeRecoversActualRenameFailure(t *testing.T) {
	...
	if !errors.As(err, &rename) || rename.Op != "rename" || !reflect.DeepEqual(input, ReleaseMeasurementInput{}) || fixture.runtime.stats.egressGeneration != 1 || !fixture.runtime.stats.attemptCutPending {
	...
	after, err := readReleaseMeasurementInputV2(path, fixture.options.MaxJournalBytes)
	if err != nil || !bytes.Equal(before, after) || !reflect.DeepEqual(recovered, journal.MeasurementInput) || fixture.runtime.objects.writes != writes || fixture.runtime.stats.egressGeneration != 2 || fixture.runtime.stats.attemptCutPending {
...
func TestReleaseMeasurementInputV2RejectsForeignConfigAtFirstPublication(t *testing.T) {
	...
	for _, edit := range []func(*ReleaseConfig){
		...
		input, err := fixture.steerer.loadOrDetachReleaseMeasurementInputV2(t.Context(), 9, 7, 200, fixture.nativeHash, fixture.snapshot, fixture.fresh(t))
		if err == nil || !reflect.DeepEqual(input, ReleaseMeasurementInput{}) || fixture.runtime.stats.egressGeneration != 1 {
