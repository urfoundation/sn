...
func TestAttemptSettlementRuntimeV2ActivationRejectsMutatedLegacyHistory(t *testing.T) {
	...
	if err := initializeAttemptSettlementEpochV2(t.Context(), fixture.coordinator, fixture.participants, 43, fixture.options(t).Authority, runtimeAttemptSettlementV2TestPersistence(), physical); err == nil || writes != 0 { t.Fatalf("mutated signed legacy history entered activation: %v/%d", err, writes) }
}
