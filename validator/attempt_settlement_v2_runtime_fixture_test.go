...
func newAttemptSettlementRuntimeV2TestFixture(t *testing.T, activate bool) *attemptSettlementRuntimeV2TestFixture {
	...
	if activate {
		if err := InitializeAttemptSettlementEpochV2(t.Context(), fixture.coordinator, fixture.participants, 42, fixture.options(t).Authority, runtimeAttemptSettlementV2TestPersistence()); err != nil { t.Fatalf("actual empty activation: %v", err) }
	}
	return fixture
}
