...
func TestAttemptSettlementRuntimeV2PhysicalPathRequiredBeforePersistence(t *testing.T) {
	...
	if err := InitializeAttemptSettlementEpochV2(t.Context(), fixture.coordinator, fixture.participants, 42, fixture.options(t).Authority); err != nil { t.Fatalf("physical canonical namespace refused: %v", err) }
	...
	if err := initializeAttemptSettlementEpochV2(t.Context(), alias, fixture.participants, 42, fixture.options(t).Authority, physical); err == nil || writes != 0 { t.Fatalf("v2 normalized an alias candidate: %v/%d", err, writes) }
