...
release_phase_runtime() {
  ...
  runtime455_tests='^Test(Runtime461|Runtime460|Runtime459|Runtime458|Runtime455|ReleaseGatesAttest.*Runtime|ProducerGatePinsRuntime458|ReviewedRuntimeIdentity|ReviewedHistoricalRuntimeArtifacts|ReleaseHistoryRuntimeArtifacts|RuntimeVersionIdentity|RuntimeCodeHashValidation|RuntimeMetadataHashValidation|ReleaseLockDecodesCanonicalRuntimeFields|ReleaseLockRejectsGeneratedRuntimeDrift|ResolvedConfigPinsReviewedRuntimeArtifactIdentity|PublishedManifestBindsCompleteRuntimeIdentity|ReleaseRuntimeRPCRetry|ReleaseSubstrateDial|CurrentRuntimeAuthenticationCannotUseHistoricalCache|CarriedFleetHistory|HistoricalFleetGenerationOne|HistoricalFleetAlias|FinalSemanticRPC|FinalSemanticSubstrate|FinalSemanticCapturedReplay)'
...
release_phase_semantic_serial() {
  ...
  semantic_serial_skip_tests='^(TestPublicScenarioBundleRequiresReplicatedOwnerCompletionCommit|TestFinalSemanticFleetAuditProjectionBindsTheExistingArtifact|TestFinalSemanticDeploymentBoundaryRuntimeConfigsAreAcceptedByReleaseLoaders|TestFinalSemanticEvidenceBuildRenderAndArtifacts|TestFinalSemanticPoolRegistrationUsesEVMReceiptAndNativeSnapshot)$|^(TestFinalAttemptFixtureLedgerMatchesDurableProductionWire|TestFinalCollectorIncludesCompletedSettlementTail|TestFinalFleetGenerationAcceptsHistoricalRuntimeAndRequiresCurrentRefreshRoots|TestFinalFleetGenerationAllCarriedArtifactsSkipEmptyBatchPostcondition|TestFinalFleetGenerationDecodesExactReceiptEventFields|TestFinalFleetGenerationInstalledPublicWriteRejectsWrongTargetCalldataOrEmitter|TestFinalFleetGenerationInstalledReceiptTopologyRejectsOmissionDuplicateAndWrongEmitter|TestFinalFleetGenerationRejectsPartialOrSubstitutedPublicWrite|TestFinalFleetGenerationRejectsReceiptEventFieldOrTopicSubstitution|TestFinalFleetGenerationWriteEmitterGraphUsesDistinctHistoricalBatcher|TestFinalFleetRenewalLifecycleJoinsExactGenerationAndSource|TestFinalFleetRenewalLineageRequiresEveryApprovedGenerationAndRevocation|TestFinalFleetRenewalPartialRoundPreservesCutoffAndCompletesSuccessor|TestFinalFleetRenewalPartialRoundRejectsFabricatedClosure|TestFinalFleetRenewalPublicReplayAndArchiveRejectSubstitutions|TestFinalNativeRewardEmissionCanDecreaseAcrossEpochs|TestFinalNativeRewardV2CancellationJoinsHistoricalBatch|TestFinalNativeRewardV2HonorsRPCContextAndSharedConnectionOwnership|TestFinalNativeRewardV2ReadsExactHistoricalVectorsAndUIDStake|TestFinalPayoutArtifactCollectorUsesRetainedSigner|TestFinalPayoutArtifactConfiguredRoleCensusRejectsSubstitutions|TestFinalPayoutArtifactRejectsResignedProviderOmissionAgainstSignedMeasurement|TestFinalPayoutArtifactSeparatesProvenanceFromRootAuthorization|TestFinalPayoutArtifactSignedAuditProvenanceBindsAllDecisionSources|TestFinalPublicChainVerificationRequiresTwoCanonicalOperatorOrigins|TestFinalPublicValidatorSourcesV2BoundsRejectPartialReadResults|TestFinalPublicValidatorSourcesV2CancelsAndJoinsActiveTransport|TestFinalPublicValidatorSourcesV2KeepsDetachedEvidenceAuthority|TestFinalPublicValidatorSourcesV2KeepsNativeClockAndNullStorage|TestFinalPublicValidatorSourcesV2NativeCheckpointAuthenticatesExactPublicState|TestFinalPublicValidatorSourcesV2RefusesWritesUnpinnedAndConflictingReads|TestFinalPublicValidatorSourcesV2RetainsRealBatchesAndCanonicalHeads|TestFinalSemanticArtifactDeploymentAdmissionPrecedesSignedReplay|TestFinalSemanticCampaignArtifactReferencesDecodeEachByteOnce|TestFinalSemanticCampaignArtifactReferencesJoinEveryRecord|TestFinalSemanticCampaignArtifactReferencesKeepDocumentAndDepthBounds|TestFinalSemanticCampaignArtifactReferencesOwnDecodedInput|TestFinalSemanticCampaignArtifactReferencesPreserveJSONValues|TestFinalSemanticDeploymentArtifactRejectsIgnoredRuntimeMap|TestFinalSemanticDeploymentRejectsLegacySchemaAndPlanLockSubstitution|TestFinalSemanticDeploymentRejectsMissingReleaseLockArtifact|TestFinalSemanticDeploymentRejectsMutuallyConsistentSubstitutedRuntime|TestFinalSemanticDeploymentRejectsRootCardinalityAndAliasMutations|TestFinalSemanticDeploymentRejectsUnreviewedReleaseRuntimeHash|TestFinalSemanticDeploymentRejectsWrongUpgradeAddressAndHash|TestFinalSemanticDishonestDepositDecisionsAndPublicReplay|TestFinalSemanticEpochDepositUsesSettlementEpochNotSourceEpoch|TestFinalSemanticEvidenceFailsClosed|TestFinalSemanticFixtureHeadManifestAdmissionRequiresAuthenticatedIdentity|TestFinalSemanticFixtureHeadProjectionAdmissionPrecedesSignedReplay|TestFinalSemanticFixtureSnapshotsAreDetached|TestFinalSemanticHistoricalCoordinatorUpgradeReaderReplaysSealedRanges|TestFinalSemanticOriginalClosureRequiresExactCampaignStartMarker|TestFinalSemanticPoolAuditDistinguishesUnderpaymentFromRecovery|TestFinalSemanticReplicatedEnvelopeHonorsCancellationAfterRead|TestFinalSemanticReplicatedEnvelopePreservesEveryRejection|TestFinalSemanticReplicatedEnvelopeRechecksCurrentIdentity|TestFinalSemanticReplicatedEnvelopeVerifiesOwnedBytesOnce|TestReleaseSemanticCensusRejectsIncompleteSettlementClosureOwners|TestReleaseSemanticCensusRequiresCompleteSettlementClosureOwners)$'
  go test ./sim-testnet -run "$semantic_integrity_tests" -count=1 -skip "$semantic_serial_skip_tests" -parallel=4 -timeout 15m
  go test -race ./sim-testnet -run "$semantic_integrity_tests" -count=1 -skip "$semantic_serial_skip_tests" -parallel=4 -timeout 25m
}
release_gate_start semantic-serial release_phase_semantic_serial

# Go releases top-level parallel roots only after serial roots return. Give
# each finite cohort its own package clock under the same bounded job owner.
release_phase_semantic_parallel() {
  cd "$sn_repo"
  semantic_parallel_tests='^(TestFinalAttemptFixtureLedgerMatchesDurableProductionWire|TestFinalCollectorIncludesCompletedSettlementTail|TestFinalFleetGenerationAcceptsHistoricalRuntimeAndRequiresCurrentRefreshRoots|TestFinalFleetGenerationAllCarriedArtifactsSkipEmptyBatchPostcondition|TestFinalFleetGenerationDecodesExactReceiptEventFields|TestFinalFleetGenerationInstalledPublicWriteRejectsWrongTargetCalldataOrEmitter|TestFinalFleetGenerationInstalledReceiptTopologyRejectsOmissionDuplicateAndWrongEmitter|TestFinalFleetGenerationRejectsPartialOrSubstitutedPublicWrite|TestFinalFleetGenerationRejectsReceiptEventFieldOrTopicSubstitution|TestFinalFleetGenerationWriteEmitterGraphUsesDistinctHistoricalBatcher|TestFinalFleetRenewalLifecycleJoinsExactGenerationAndSource|TestFinalFleetRenewalLineageRequiresEveryApprovedGenerationAndRevocation|TestFinalFleetRenewalPartialRoundPreservesCutoffAndCompletesSuccessor|TestFinalFleetRenewalPartialRoundRejectsFabricatedClosure|TestFinalFleetRenewalPublicReplayAndArchiveRejectSubstitutions|TestFinalNativeRewardEmissionCanDecreaseAcrossEpochs|TestFinalNativeRewardV2CancellationJoinsHistoricalBatch|TestFinalNativeRewardV2HonorsRPCContextAndSharedConnectionOwnership|TestFinalNativeRewardV2ReadsExactHistoricalVectorsAndUIDStake|TestFinalPayoutArtifactCollectorUsesRetainedSigner|TestFinalPayoutArtifactConfiguredRoleCensusRejectsSubstitutions|TestFinalPayoutArtifactRejectsResignedProviderOmissionAgainstSignedMeasurement|TestFinalPayoutArtifactSeparatesProvenanceFromRootAuthorization|TestFinalPayoutArtifactSignedAuditProvenanceBindsAllDecisionSources|TestFinalPublicChainVerificationRequiresTwoCanonicalOperatorOrigins|TestFinalPublicValidatorSourcesV2BoundsRejectPartialReadResults|TestFinalPublicValidatorSourcesV2CancelsAndJoinsActiveTransport|TestFinalPublicValidatorSourcesV2KeepsDetachedEvidenceAuthority|TestFinalPublicValidatorSourcesV2KeepsNativeClockAndNullStorage|TestFinalPublicValidatorSourcesV2NativeCheckpointAuthenticatesExactPublicState|TestFinalPublicValidatorSourcesV2RefusesWritesUnpinnedAndConflictingReads|TestFinalPublicValidatorSourcesV2RetainsRealBatchesAndCanonicalHeads|TestFinalSemanticArtifactDeploymentAdmissionPrecedesSignedReplay|TestFinalSemanticCampaignArtifactReferencesDecodeEachByteOnce|TestFinalSemanticCampaignArtifactReferencesJoinEveryRecord|TestFinalSemanticCampaignArtifactReferencesKeepDocumentAndDepthBounds|TestFinalSemanticCampaignArtifactReferencesOwnDecodedInput|TestFinalSemanticCampaignArtifactReferencesPreserveJSONValues|TestFinalSemanticDeploymentArtifactRejectsIgnoredRuntimeMap|TestFinalSemanticDeploymentRejectsLegacySchemaAndPlanLockSubstitution|TestFinalSemanticDeploymentRejectsMissingReleaseLockArtifact|TestFinalSemanticDeploymentRejectsMutuallyConsistentSubstitutedRuntime|TestFinalSemanticDeploymentRejectsRootCardinalityAndAliasMutations|TestFinalSemanticDeploymentRejectsUnreviewedReleaseRuntimeHash|TestFinalSemanticDeploymentRejectsWrongUpgradeAddressAndHash|TestFinalSemanticDishonestDepositDecisionsAndPublicReplay|TestFinalSemanticEpochDepositUsesSettlementEpochNotSourceEpoch|TestFinalSemanticEvidenceFailsClosed|TestFinalSemanticFixtureHeadManifestAdmissionRequiresAuthenticatedIdentity|TestFinalSemanticFixtureHeadProjectionAdmissionPrecedesSignedReplay|TestFinalSemanticFixtureSnapshotsAreDetached|TestFinalSemanticHistoricalCoordinatorUpgradeReaderReplaysSealedRanges|TestFinalSemanticOriginalClosureRequiresExactCampaignStartMarker|TestFinalSemanticPoolAuditDistinguishesUnderpaymentFromRecovery|TestFinalSemanticReplicatedEnvelopeHonorsCancellationAfterRead|TestFinalSemanticReplicatedEnvelopePreservesEveryRejection|TestFinalSemanticReplicatedEnvelopeRechecksCurrentIdentity|TestFinalSemanticReplicatedEnvelopeVerifiesOwnedBytesOnce|TestReleaseSemanticCensusRejectsIncompleteSettlementClosureOwners|TestReleaseSemanticCensusRequiresCompleteSettlementClosureOwners)$'
...
release_gate_start semantic-parallel release_phase_semantic_parallel
...
release_phase_capture_revision() {
  cd "$sn_repo"
  capture_revision_tests='^TestFleetRenewalRevision(PreservesApprovedRoundsAndChargesOnce|RestoresCompletedHistoricalActions|RefusesCustodyFeeOrLiabilityChanges)$'
...
release_phase_solidity() {
  ...
  validator_evidence_tests='^Test(ValidatorEvidence|RuntimeEvidenceV2|RuntimeEvidence|EvidenceRelay|EvidencePolicyGap|EvidencePolicyRollover|EvmTxManager|ClientKeyHistory|RuntimeProvisional|ProvisionalRelay|RelayContinuation)'
...
# Ordinary evidence roots keep separate serial and parallel package clocks.
# The retained combined race clock expired while the final historical mutation
# root had run for only 85 seconds. Preserve every source-derived root, both
# modes and the existing ten-minute bounds; full renders keep their own owners.
release_phase_evidence_simulator() {
  cd "$sn_repo"
  simulator_evidence_tests='^Test(ValidatorEvidence|RuntimeEvidenceV2|RuntimeEvidence|EvidenceRelay|EvidencePolicyGap|EvidencePolicyRollover|EvmTxManager|ClientKeyHistory|RuntimeProvisional|ProvisionalRelay|RelayContinuation)'
  simulator_evidence_serial_skip_tests='^(TestRuntimeEvidenceLaunchV2TemplateReachesGeneratedSetupAndRender|TestValidatorEvidenceCarryPublicOverrideRequiresCompleteClonedHeads|TestRuntimeEvidenceOwnedReservedStagingRerenderReplacesProvisionalConfig|TestRuntimeProvisionalStagingRenderBindsRetainedAuthority|TestRuntimeProvisionalStagingRejectsChangedSourceAndAuthority|TestEvidenceRelayContinuationNonceOwnedRouteRetainsLiabilityChecks|TestEvidenceRelayContinuationNonceOwnedRouteUsesOneObserver|TestEvidenceRelayContinuationNoncePrivateAuthorityComparesPinnedState|TestEvidenceRelayContinuationNoncePrivateAuthorityRequiresIndependentReader|TestEvidenceRelayContinuationNonceSharedModesDoNotUseAnExtraReader|TestEvidenceRelayContinuationNonceTimeoutThenSamePinnedValue|TestEvidenceRelayOwnerPlanCacheBoundsEntriesAndRetainedBytes|TestEvidenceRelayOwnerPlanCacheDoesNotPublishFailedOrCanceledValidation|TestEvidenceRelayOwnerPlanCacheKeepsRequestsAndJournalFresh|TestEvidenceRelayOwnerPlanCacheRejectsMissingEmptyPartialAndCanceledReads|TestEvidenceRelayOwnerPlanCacheReusesExactArchivedBytes|TestEvidenceRelayPhaseSchedulerAdmitsBeforeBacklogDrains|TestEvidenceRelayPhaseSchedulerCanceledRequestAllowsFreshRetry|TestEvidenceRelayPhaseSchedulerCancellationPreservesAdjacentErrors|TestEvidenceRelayPhaseSchedulerKeepsRealValidationFailuresBlocking|TestEvidenceRelaySourceExpansionFitsFullWorkAndReportsExactFailure|TestEvidenceRelaySourceExpansionPreservesLineageAndRendersApprovedBounds|TestEvidenceRelaySourceExpansionRefreshAndImportCannotChangeApproval|TestEvidenceRelaySourceExpansionRequiresExplicitCaptureOption|TestEvidenceRelaySourceExpansionRetainedManifestAndValidatorHandoff|TestEvidenceRelayTransactionStateDirectoryCustody|TestEvmTxManagerIndependentReadExecutorKeepsAllAccountOwners|TestEvmTxManagerReadCloneDoesNotCopyActiveNonceState|TestEvmTxManagerReadClonePreservesMissingRoles|TestRuntimeEvidenceLaunchV2TemplateRejectsMissingAndForeignCreation|TestRuntimeEvidenceProvisionV2ChangedInputCannotBeRehashedIntoAuthority|TestRuntimeEvidenceProvisionV2FixedPlanBoundsAllFourKeeperActions|TestRuntimeEvidenceProvisionV2FreshSetupPreservesExistingDiskHistory|TestRuntimeEvidenceProvisionV2HeaderCapacityMatchesPublicReader|TestRuntimeEvidenceProvisionV2InterruptedLastSourceResumesExactConsents|TestRuntimeEvidenceProvisionV2NoImplicitBudgetOrFabricatedReferences|TestRuntimeEvidenceProvisionV2RetainsActualFilesAndResolvesSameTemplate|TestRuntimeEvidenceProvisionV2SignedForeignSourceIsRefusedBeforeFiles|TestRuntimeEvidenceSetupCanceledDiscoveryCannotClaimAbsence|TestRuntimeEvidenceSetupCarryV2ClosedAncestorAttemptsAuthenticateOldApproval|TestRuntimeEvidenceSetupCarryV2ClosedAncestorAttemptsKeepOriginalSetup|TestRuntimeEvidenceSetupCarryV2ClosedAncestorAttemptsRejectTransactionMetadata|TestRuntimeEvidenceSetupCarryV2ClosedAncestorAttemptsRejectUnfinishedProgress|TestRuntimeEvidenceSetupCarryV2RejectsChangedReceiptAndSignedTransaction|TestRuntimeEvidenceSetupCarryV2RejectsForeignLineageAndDomain|TestRuntimeEvidenceSetupCarryV2RejectsPartialAndCompetingProgress|TestRuntimeEvidenceSetupCarryV2ResolvesOriginalFilesAfterSourceRevision|TestRuntimeEvidenceSetupPreflightRequiresUnstartedReceipts|TestRuntimeEvidenceSetupReadClassifiesMissingEmptyAndMalformed|TestRuntimeEvidenceSetupReadRejectsNonregularAndOversizedReceipts|TestRuntimeEvidenceSetupRequiredReadersRejectIncompleteReceipts|TestRuntimeEvidenceV2AttemptUploadApplyAdmitsConfiguredJournalBoundary|TestRuntimeEvidenceV2AttemptUploadApplyRefusesBeforeJournalOwnership|TestRuntimeEvidenceV2AttemptUploadBudgetAdmissionOwnsExactValues|TestRuntimeEvidenceV2AttemptUploadConfigRequiresExactProfileAndYAML|TestRuntimeEvidenceV2AttemptUploadConfigRequiresOwnedBoundedFile|TestRuntimeEvidenceV2AttemptUploadDispatchRefusesBeforePayloadRecovery|TestRuntimeEvidenceV2AttemptUploadGeneratedConfigRejectsExtraFiles|TestRuntimeEvidenceV2AttemptUploadLaunchRefusesBeforeMigration|TestRuntimeEvidenceV2AttemptUploadManifestBindsEveryLimit|TestRuntimeEvidenceV2AttemptUploadManifestOwnsGeneratedOperatorConfigs|TestRuntimeEvidenceV2AttemptUploadManifestRejectsGeneratedConfigOmissionAndTamper|TestRuntimeEvidenceV2AttemptUploadManifestRejectsRehashedSettings|TestRuntimeEvidenceV2AttemptUploadPreservesUnprovisionedPlanningWire|TestRuntimeEvidenceV2AttemptUploadRenderRefusesInvalidBeforeMutation|TestRuntimeEvidenceV2AttemptUploadStrictHarnessBudget|TestRuntimeEvidenceV2ReservedCreationRejectsForgedIntentAndForeignDeployment|TestRuntimeEvidenceV2ReservedCreationRejectsMissingOrChangedSources|TestRuntimeEvidenceV2ReservedCreationRequiresOriginalPredecessorCarry|TestRuntimeEvidenceV2ReservedCreationRetainsOriginalSourceOnRestart|TestRuntimeEvidenceV2ReservedCreationSeparatesReorgFromFinalConflict|TestRuntimeEvidenceV2ReservedRendererRejectsMissingOrChangedSetup|TestValidatorEvidenceCarryAuthenticatesBothIndependentProviders|TestValidatorEvidenceCarryAuthenticatesOriginalApprovalAndRuntime|TestValidatorEvidenceCarryCanceledReadReturnsNoAuthority|TestValidatorEvidenceCarryExecutorNeverRedeploysOrReanchors|TestValidatorEvidenceCarryHistoricalActionRecovery|TestValidatorEvidenceCarryHistoricalAncestorsRemainReadOnly|TestValidatorEvidenceCarryHistoricalCaptureCensus|TestValidatorEvidenceCarryHistoricalCommitmentRecovery|TestValidatorEvidenceCarryHistoricalCoordinatorBaseline|TestValidatorEvidenceCarryHistoricalFilesRejectSameOwnerAliases|TestValidatorEvidenceCarryHistoricalFilesRejectSpecialComponents|TestValidatorEvidenceCarryHistoricalFilesUseNativeNonblockingOpen|TestValidatorEvidenceCarryIndependentModeCannotBorrowPublicReceipts|TestValidatorEvidenceCarryNonceSuffixIsConsumedExactlyOnce|TestValidatorEvidenceCarryObservedUpgradeAndContinuationPreserveOriginalJournal|TestValidatorEvidenceCarryOriginalSignedEnvelopesRemainExact|TestValidatorEvidenceCarryRefusesArchivedSourceSubstitution|TestValidatorEvidenceCarryRejectsConfiguredDomainDriftBeforeRPC|TestValidatorEvidenceCarryRejectsConflictingFinalizedHTTPHistory|TestValidatorEvidenceCarryRejectsIncompleteOriginalJournal|TestValidatorEvidenceCarryRejectsUnreviewedABIAndImmutableAliases|TestValidatorEvidenceCarryRevisionBindsFreshActivationAndRelayOwners|TestValidatorEvidenceCarryRevisionRetainsOriginalActionsAndSpend|TestValidatorEvidenceCarrySourceTransportBoundsPrecedeDecoding|TestValidatorEvidenceHistoricalLockKeepsAdjacentLineageAuthority|TestValidatorEvidenceHistoricalLockKeepsCurrentReleaseAuthority|TestValidatorEvidenceHistoricalLockPreservesStaticControls|TestValidatorEvidenceHistoricalLockRejectsApprovalDrift|TestValidatorEvidenceHistoricalLockRejectsForeignRuntime|TestValidatorEvidenceHistoricalLockReopensOriginalApproval|TestValidatorEvidenceHistoricalLockRestartsCurrentCarry)$'
...
release_phase_evidence_simulator_parallel() {
  cd "$sn_repo"
  simulator_evidence_parallel_tests='^(TestEvidenceRelayContinuationNonceOwnedRouteRetainsLiabilityChecks|TestEvidenceRelayContinuationNonceOwnedRouteUsesOneObserver|TestEvidenceRelayContinuationNoncePrivateAuthorityComparesPinnedState|TestEvidenceRelayContinuationNoncePrivateAuthorityRequiresIndependentReader|TestEvidenceRelayContinuationNonceSharedModesDoNotUseAnExtraReader|TestEvidenceRelayContinuationNonceTimeoutThenSamePinnedValue|TestEvidenceRelayOwnerPlanCacheBoundsEntriesAndRetainedBytes|TestEvidenceRelayOwnerPlanCacheDoesNotPublishFailedOrCanceledValidation|TestEvidenceRelayOwnerPlanCacheKeepsRequestsAndJournalFresh|TestEvidenceRelayOwnerPlanCacheRejectsMissingEmptyPartialAndCanceledReads|TestEvidenceRelayOwnerPlanCacheReusesExactArchivedBytes|TestEvidenceRelayPhaseSchedulerAdmitsBeforeBacklogDrains|TestEvidenceRelayPhaseSchedulerCanceledRequestAllowsFreshRetry|TestEvidenceRelayPhaseSchedulerCancellationPreservesAdjacentErrors|TestEvidenceRelayPhaseSchedulerKeepsRealValidationFailuresBlocking|TestEvidenceRelaySourceExpansionFitsFullWorkAndReportsExactFailure|TestEvidenceRelaySourceExpansionPreservesLineageAndRendersApprovedBounds|TestEvidenceRelaySourceExpansionRefreshAndImportCannotChangeApproval|TestEvidenceRelaySourceExpansionRequiresExplicitCaptureOption|TestEvidenceRelaySourceExpansionRetainedManifestAndValidatorHandoff|TestEvidenceRelayTransactionStateDirectoryCustody|TestEvmTxManagerIndependentReadExecutorKeepsAllAccountOwners|TestEvmTxManagerReadCloneDoesNotCopyActiveNonceState|TestEvmTxManagerReadClonePreservesMissingRoles|TestRuntimeEvidenceLaunchV2TemplateRejectsMissingAndForeignCreation|TestRuntimeEvidenceProvisionV2ChangedInputCannotBeRehashedIntoAuthority|TestRuntimeEvidenceProvisionV2FixedPlanBoundsAllFourKeeperActions|TestRuntimeEvidenceProvisionV2FreshSetupPreservesExistingDiskHistory|TestRuntimeEvidenceProvisionV2HeaderCapacityMatchesPublicReader|TestRuntimeEvidenceProvisionV2InterruptedLastSourceResumesExactConsents|TestRuntimeEvidenceProvisionV2NoImplicitBudgetOrFabricatedReferences|TestRuntimeEvidenceProvisionV2RetainsActualFilesAndResolvesSameTemplate|TestRuntimeEvidenceProvisionV2SignedForeignSourceIsRefusedBeforeFiles|TestRuntimeEvidenceSetupCanceledDiscoveryCannotClaimAbsence|TestRuntimeEvidenceSetupCarryV2ClosedAncestorAttemptsAuthenticateOldApproval|TestRuntimeEvidenceSetupCarryV2ClosedAncestorAttemptsKeepOriginalSetup|TestRuntimeEvidenceSetupCarryV2ClosedAncestorAttemptsRejectTransactionMetadata|TestRuntimeEvidenceSetupCarryV2ClosedAncestorAttemptsRejectUnfinishedProgress|TestRuntimeEvidenceSetupCarryV2RejectsChangedReceiptAndSignedTransaction|TestRuntimeEvidenceSetupCarryV2RejectsForeignLineageAndDomain|TestRuntimeEvidenceSetupCarryV2RejectsPartialAndCompetingProgress|TestRuntimeEvidenceSetupCarryV2ResolvesOriginalFilesAfterSourceRevision|TestRuntimeEvidenceSetupPreflightRequiresUnstartedReceipts|TestRuntimeEvidenceSetupReadClassifiesMissingEmptyAndMalformed|TestRuntimeEvidenceSetupReadRejectsNonregularAndOversizedReceipts|TestRuntimeEvidenceSetupRequiredReadersRejectIncompleteReceipts|TestRuntimeEvidenceV2AttemptUploadApplyAdmitsConfiguredJournalBoundary|TestRuntimeEvidenceV2AttemptUploadApplyRefusesBeforeJournalOwnership|TestRuntimeEvidenceV2AttemptUploadBudgetAdmissionOwnsExactValues|TestRuntimeEvidenceV2AttemptUploadConfigRequiresExactProfileAndYAML|TestRuntimeEvidenceV2AttemptUploadConfigRequiresOwnedBoundedFile|TestRuntimeEvidenceV2AttemptUploadDispatchRefusesBeforePayloadRecovery|TestRuntimeEvidenceV2AttemptUploadGeneratedConfigRejectsExtraFiles|TestRuntimeEvidenceV2AttemptUploadLaunchRefusesBeforeMigration|TestRuntimeEvidenceV2AttemptUploadManifestBindsEveryLimit|TestRuntimeEvidenceV2AttemptUploadManifestOwnsGeneratedOperatorConfigs|TestRuntimeEvidenceV2AttemptUploadManifestRejectsGeneratedConfigOmissionAndTamper|TestRuntimeEvidenceV2AttemptUploadManifestRejectsRehashedSettings|TestRuntimeEvidenceV2AttemptUploadPreservesUnprovisionedPlanningWire|TestRuntimeEvidenceV2AttemptUploadRenderRefusesInvalidBeforeMutation|TestRuntimeEvidenceV2AttemptUploadStrictHarnessBudget|TestRuntimeEvidenceV2ReservedCreationRejectsForgedIntentAndForeignDeployment|TestRuntimeEvidenceV2ReservedCreationRejectsMissingOrChangedSources|TestRuntimeEvidenceV2ReservedCreationRequiresOriginalPredecessorCarry|TestRuntimeEvidenceV2ReservedCreationRetainsOriginalSourceOnRestart|TestRuntimeEvidenceV2ReservedCreationSeparatesReorgFromFinalConflict|TestRuntimeEvidenceV2ReservedRendererRejectsMissingOrChangedSetup|TestValidatorEvidenceCarryAuthenticatesBothIndependentProviders|TestValidatorEvidenceCarryAuthenticatesOriginalApprovalAndRuntime|TestValidatorEvidenceCarryCanceledReadReturnsNoAuthority|TestValidatorEvidenceCarryExecutorNeverRedeploysOrReanchors|TestValidatorEvidenceCarryHistoricalActionRecovery|TestValidatorEvidenceCarryHistoricalAncestorsRemainReadOnly|TestValidatorEvidenceCarryHistoricalCaptureCensus|TestValidatorEvidenceCarryHistoricalCommitmentRecovery|TestValidatorEvidenceCarryHistoricalCoordinatorBaseline|TestValidatorEvidenceCarryHistoricalFilesRejectSameOwnerAliases|TestValidatorEvidenceCarryHistoricalFilesRejectSpecialComponents|TestValidatorEvidenceCarryHistoricalFilesUseNativeNonblockingOpen|TestValidatorEvidenceCarryIndependentModeCannotBorrowPublicReceipts|TestValidatorEvidenceCarryNonceSuffixIsConsumedExactlyOnce|TestValidatorEvidenceCarryObservedUpgradeAndContinuationPreserveOriginalJournal|TestValidatorEvidenceCarryOriginalSignedEnvelopesRemainExact|TestValidatorEvidenceCarryRefusesArchivedSourceSubstitution|TestValidatorEvidenceCarryRejectsConfiguredDomainDriftBeforeRPC|TestValidatorEvidenceCarryRejectsConflictingFinalizedHTTPHistory|TestValidatorEvidenceCarryRejectsIncompleteOriginalJournal|TestValidatorEvidenceCarryRejectsUnreviewedABIAndImmutableAliases|TestValidatorEvidenceCarryRevisionBindsFreshActivationAndRelayOwners|TestValidatorEvidenceCarryRevisionRetainsOriginalActionsAndSpend|TestValidatorEvidenceCarrySourceTransportBoundsPrecedeDecoding|TestValidatorEvidenceHistoricalLockKeepsAdjacentLineageAuthority|TestValidatorEvidenceHistoricalLockKeepsCurrentReleaseAuthority|TestValidatorEvidenceHistoricalLockPreservesStaticControls|TestValidatorEvidenceHistoricalLockRejectsApprovalDrift|TestValidatorEvidenceHistoricalLockRejectsForeignRuntime|TestValidatorEvidenceHistoricalLockReopensOriginalApproval|TestValidatorEvidenceHistoricalLockRestartsCurrentCarry)$'
  go test ./sim-testnet -run "$simulator_evidence_parallel_tests" -count=1 -timeout 10m
  go test -race ./sim-testnet -run "$simulator_evidence_parallel_tests" -count=1 -timeout 10m
}
release_gate_start evidence-simulator-parallel release_phase_evidence_simulator_parallel
...
# Each provisional staging fixture retains its full population and receives
# the same independent normal/race deadline as the original renderer owner.
release_phase_evidence_simulator_provisional_render() {
  cd "$sn_repo"
  simulator_evidence_provisional_render_tests='^TestRuntimeProvisionalStagingRenderBindsRetainedAuthority$'
  go test ./sim-testnet -run "$simulator_evidence_provisional_render_tests" -count=1 -timeout 10m
  go test -race ./sim-testnet -run "$simulator_evidence_provisional_render_tests" -count=1 -timeout 10m
}
release_gate_start evidence-simulator-provisional-render release_phase_evidence_simulator_provisional_render

release_phase_evidence_simulator_provisional_reject() {
  cd "$sn_repo"
  simulator_evidence_provisional_reject_tests='^TestRuntimeProvisionalStagingRejectsChangedSourceAndAuthority$'
  go test ./sim-testnet -run "$simulator_evidence_provisional_reject_tests" -count=1 -timeout 10m
  go test -race ./sim-testnet -run "$simulator_evidence_provisional_reject_tests" -count=1 -timeout 10m
}
release_gate_start evidence-simulator-provisional-reject release_phase_evidence_simulator_provisional_reject
