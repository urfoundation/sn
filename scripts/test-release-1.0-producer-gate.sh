...
release_phase_runtime() {
  ...
  # current reviewed identity, historical metadata cache, per-endpoint
...
release_phase_solidity() {
  ...
  validator_evidence_tests='^Test(ValidatorEvidence|RuntimeEvidenceV2|RuntimeEvidence|EvidenceRelay|EvmTxManager|ClientKeyHistory|RuntimeProvisional|ProvisionalRelay|RelayContinuation)'
