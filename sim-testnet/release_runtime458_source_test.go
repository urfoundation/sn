...
func TestRuntime458SourceAttestationIncludesExactCompatibilityDelta(t *testing.T) {
	...
	for _, required := range []string{"for current_spec in 455 458", "runtime-v458-source.sha256", "current_commit=\"a7ae07e5dd37b552f27aa8e4d7716c522eef9aa7\"", "expected_current_files=62", "SUBTENSOR_RUNTIME458_SOURCE", "expected_files=29", "expected_metadata_files=27"} {
