#!/usr/bin/env bash
set -euo pipefail
render_capture='/home/by/urnetwork/temp/sn-infrastructure-release-integration-20260914/lock-preview-historical455-d11c544'
...
sha256sum '/home/by/urnetwork/temp/sn-warp-admission-integration-20260913/workspace-physical/terra-runtime/final-cli-c572d993-canonical-r3/sim-testnet' >"$render_capture/executable.sha256"
test "$(cut -d ' ' -f 1 "$render_capture/executable.sha256")" = 'e5375d52e46758c392ba538bcd95a1d1fb6e37eac5e689a2832dbf299c927638'
while IFS=$'\t' read -r render_repo render_expected render_clean; do
  if [[ "$render_repo" == "$render_source" ]]; then render_expected='d11c544f114ee6acf0a36ad5d639c73c1783bc70'; fi
...
test "$(cut -d ' ' -f 1 "$render_capture/lock.before.sha256")" = 'd11b2a41ca6e836f9267088f8899c4fb0faf53b78b3b9ca8804bab589cd63e7b'
export GOMAXPROCS='1'
export GOENV='off'
export GOWORK='off'
export GOPROXY='off'
...
export TMPDIR='/home/by/urnetwork/temp/sn-infrastructure-release-integration-20260914/lock-preview-historical455-d11c544/tmp'
export GOTMPDIR='/home/by/urnetwork/temp/sn-infrastructure-release-integration-20260914/lock-preview-historical455-d11c544/gotmp'
