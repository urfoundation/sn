...
set -u -o pipefail
umask 077
native_capture='/home/by/urnetwork/temp/sn-infrastructure-release-integration-20260914/native-setup-preview-eccfae8'
...
test "$(git rev-parse HEAD)" = 'eccfae8a5f4176ccaa6099ce5ce555924057f3d3' || exit 125
test "$(git rev-parse origin/main)" = 'eccfae8a5f4176ccaa6099ce5ce555924057f3d3' || exit 125
...
sha256sum '/home/by/urnetwork/temp/sn-warp-admission-integration-20260913/workspace-physical/terra-runtime/final-cli-eccfae8-canonical/sim-testnet' > "$native_capture/binary.before.sha256"
