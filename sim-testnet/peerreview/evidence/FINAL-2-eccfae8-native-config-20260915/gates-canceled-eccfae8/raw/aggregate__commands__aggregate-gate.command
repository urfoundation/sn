...
exec env TMPDIR="$runtime/tmp" RELEASE_GATE_CONCURRENT_GATES=2 RELEASE_GATE_JOBS=1 RUN_SERVER_DB_TESTS=1 RELEASE_GATE_DIAGNOSTIC=0 bash "$FINAL_WORKSPACE/sn/scripts/test-release-1.0-local.sh"
