...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/portable-server-retry/causal/unfiltered-claims-taskworker/body/normal'
