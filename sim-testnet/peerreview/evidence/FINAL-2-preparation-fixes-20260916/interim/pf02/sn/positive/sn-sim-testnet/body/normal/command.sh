...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/sn-sim-testnet/body/normal'
source='/home/by/urnetwork/temp/sn-taskworker-profile-20260916/workspace/sn'
expected='8e6d56b5a40c897a91ce80b94439239ce29de4ef'
pkg='./sim-testnet'
packageid='github.com/urnetwork/sn/sim-testnet'
testenv='none'
compiler='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/sn-sim-testnet/compile/normal'
binary='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/sn-sim-testnet/compile/normal/sn-sim-testnet.normal.test'
selector='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/sn-sim-testnet/selector.txt'
expected_tests='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/sn-sim-testnet/expected-tests.txt'
expected_outcomes='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/sn-sim-testnet/expected-outcomes.tsv'
deps='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/admission/positive-sn-sim-testnet.dependencies.expected.tsv'
expected_exit='0'
