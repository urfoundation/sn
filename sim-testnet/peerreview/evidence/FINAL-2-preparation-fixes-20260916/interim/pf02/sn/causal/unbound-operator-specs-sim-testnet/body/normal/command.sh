...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unbound-operator-specs-sim-testnet/body/normal'
source='/home/by/urnetwork/temp/sn-taskworker-profile-20260916/causal/unbound_operator_specs/workspace/sn'
expected='e6e657900a6f14927537736d7a9912bf81992995'
pkg='./sim-testnet'
packageid='github.com/urnetwork/sn/sim-testnet'
testenv='none'
compiler='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unbound-operator-specs-sim-testnet/compile/normal'
binary='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unbound-operator-specs-sim-testnet/compile/normal/unbound-operator-specs-sim-testnet.normal.test'
selector='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unbound-operator-specs-sim-testnet/selector.txt'
expected_tests='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unbound-operator-specs-sim-testnet/expected-tests.txt'
expected_outcomes='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unbound-operator-specs-sim-testnet/expected-outcomes.tsv'
deps='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/admission/causal-unbound-operator-specs-sim-testnet.dependencies.expected.tsv'
expected_exit='1'
