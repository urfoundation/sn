...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/portable-server-retry-2/positive/server-task/body/race'
...
testenv='server'
compiler='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/server-task/compile/race'
binary='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/server-task/compile/race/server-task.race.test'
