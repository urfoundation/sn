...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/portable-server-retry-2/positive/server-taskworker/body/normal'
...
testenv='server'
compiler='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/server-taskworker/compile/normal'
binary='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/server-taskworker/compile/normal/server-taskworker.normal.test'
...
expected_tests='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/server-taskworker/expected-tests.txt'
expected_outcomes='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/server-taskworker/expected-outcomes.tsv'
