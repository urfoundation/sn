...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/portable-server-retry-2/positive/server-taskworker/body/race'
...
testenv='server'
compiler='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/positive/server-taskworker/compile/race'
