...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/portable-server-retry-2/causal/unrestricted-profile-initialization-taskworker/body/normal'
source='/home/by/urnetwork/temp/sn-taskworker-profile-20260916/causal/unrestricted_profile_initialization/workspace/server'
expected='04306dbb81b463404a9b780da23d6fe428521b8f'
pkg='./taskworker'
packageid='github.com/urnetwork/server/taskworker'
testenv='server'
compiler='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unrestricted-profile-initialization-taskworker/compile/normal'
binary='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unrestricted-profile-initialization-taskworker/compile/normal/unrestricted-profile-initialization-taskworker.normal.test'
selector='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unrestricted-profile-initialization-taskworker/selector.txt'
expected_tests='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unrestricted-profile-initialization-taskworker/expected-tests.txt'
expected_outcomes='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unrestricted-profile-initialization-taskworker/expected-outcomes.tsv'
deps='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/admission/causal-unrestricted-profile-initialization-taskworker.dependencies.expected.tsv'
expected_exit='1'
expected_package='FAIL'
body_status=125
final_status=125
source_fence() {
