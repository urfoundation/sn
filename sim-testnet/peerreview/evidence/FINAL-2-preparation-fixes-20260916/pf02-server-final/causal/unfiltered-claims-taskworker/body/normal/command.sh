...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/portable-server-retry-2/causal/unfiltered-claims-taskworker/body/normal'
source='/home/by/urnetwork/temp/sn-taskworker-profile-20260916/causal/unfiltered_claims/workspace/server'
expected='731d127b608ce2317cacd3cf1a80d6a8da5a4362'
pkg='./taskworker'
packageid='github.com/urnetwork/server/taskworker'
testenv='server'
compiler='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unfiltered-claims-taskworker/compile/normal'
binary='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unfiltered-claims-taskworker/compile/normal/unfiltered-claims-taskworker.normal.test'
selector='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unfiltered-claims-taskworker/selector.txt'
expected_tests='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unfiltered-claims-taskworker/expected-tests.txt'
expected_outcomes='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unfiltered-claims-taskworker/expected-outcomes.tsv'
deps='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/admission/causal-unfiltered-claims-taskworker.dependencies.expected.tsv'
expected_exit='1'
