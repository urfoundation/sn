...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/portable-server-retry-2/causal/unfiltered-claims-task/body/normal'
...
testenv='server'
compiler='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unfiltered-claims-task/compile/normal'
binary='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unfiltered-claims-task/compile/normal/unfiltered-claims-task.normal.test'
selector='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unfiltered-claims-task/selector.txt'
expected_tests='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unfiltered-claims-task/expected-tests.txt'
expected_outcomes='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/causal/unfiltered-claims-task/expected-outcomes.tsv'
deps='/mnt/data/sn-testnet/qualification/taskworker-profile-20260916-r1/terra/final/admission/causal-unfiltered-claims-task.dependencies.expected.tsv'
expected_exit='1'
