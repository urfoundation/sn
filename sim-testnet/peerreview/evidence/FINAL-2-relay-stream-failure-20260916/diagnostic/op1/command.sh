...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/native-recovery-20260916-r2/relay-artifact-read-20260916-r1/op1
...
url='http://127.0.0.1:18081/sn/attempt-artifact?kind=metadata&hash=0x74d265dccdbcee7a218e229abd199708e15f0035481cc5ec8d0b55f2bb5ed273'
status=125
