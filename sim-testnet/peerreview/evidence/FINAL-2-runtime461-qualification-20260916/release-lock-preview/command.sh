...
umask 077
native_capture='/mnt/data/sn-testnet/qualification/native-recovery-20260916-r5/release-lock-preview'
...
native_cli='/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/runtime461-renderer-cli/sim-testnet'
...
# Renderer was built at this exact qualified runtime461 source.
