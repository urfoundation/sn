...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_config_identity_gate/sim-testnet
source=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/causal/prior_config_identity_gate/workspace/sn
compiler=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/compile/prior_config_identity_gate/sim-testnet
binary=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/compile/prior_config_identity_gate/sim-testnet/sim-testnet.causal.test
selector=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_config_identity_gate/sim-testnet/selector.txt
expected_tests=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_config_identity_gate/sim-testnet/expected-tests.txt
expected_pass=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_config_identity_gate/sim-testnet/expected-pass-tests.txt
expected_fail=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_config_identity_gate/sim-testnet/expected-fail-tests.txt
expected_body_exit=1
siblings=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/causal/prior_config_identity_gate/workspace/sn/../../SIBLINGS.tsv
variant_json=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/causal/prior_config_identity_gate/workspace/sn/../../VARIANT.json
expected=310c2de2fa6e8c39893c09820a9227b3ac47e410
