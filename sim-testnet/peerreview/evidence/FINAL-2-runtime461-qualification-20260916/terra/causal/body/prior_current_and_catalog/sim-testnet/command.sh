...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_current_and_catalog/sim-testnet
source=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/causal/prior_current_and_catalog/workspace/sn
compiler=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/compile/prior_current_and_catalog/sim-testnet
binary=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/compile/prior_current_and_catalog/sim-testnet/sim-testnet.causal.test
selector=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_current_and_catalog/sim-testnet/selector.txt
expected_tests=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_current_and_catalog/sim-testnet/expected-tests.txt
expected_pass=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_current_and_catalog/sim-testnet/expected-pass-tests.txt
expected_fail=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_current_and_catalog/sim-testnet/expected-fail-tests.txt
