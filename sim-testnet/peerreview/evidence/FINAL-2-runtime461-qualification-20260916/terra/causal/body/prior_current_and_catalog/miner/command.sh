...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_current_and_catalog/miner
source=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/causal/prior_current_and_catalog/workspace/sn
compiler=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/compile/prior_current_and_catalog/miner
binary=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/compile/prior_current_and_catalog/miner/miner.causal.test
selector=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_current_and_catalog/miner/selector.txt
expected_tests=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_current_and_catalog/miner/expected-tests.txt
expected_pass=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_current_and_catalog/miner/expected-pass-tests.txt
expected_fail=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_current_and_catalog/miner/expected-fail-tests.txt
