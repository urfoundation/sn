...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_companion_provenance/sim-testnet
source=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/causal/prior_companion_provenance/workspace/sn
compiler=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/compile/prior_companion_provenance/sim-testnet
binary=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/compile/prior_companion_provenance/sim-testnet/sim-testnet.causal.test
selector=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_companion_provenance/sim-testnet/selector.txt
expected_tests=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_companion_provenance/sim-testnet/expected-tests.txt
expected_pass=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_companion_provenance/sim-testnet/expected-pass-tests.txt
expected_fail=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/causal/body/prior_companion_provenance/sim-testnet/expected-fail-tests.txt
expected_body_exit=1
siblings=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/causal/prior_companion_provenance/workspace/sn/../../SIBLINGS.tsv
variant_json=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/causal/prior_companion_provenance/workspace/sn/../../VARIANT.json
expected=f7de86fa985a1c3062a31ea224b8bd8a71e24fd4
package_dir=sim-testnet
status=125
