...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/body/crv4-race
source=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/workspace/sn
compiler=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/compile/crv4-race
binary=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/compile/crv4-race/crv4.race.test
selector=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/body/crv4-race/selector.txt
expected_tests=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/body/crv4-race/expected-tests.txt
