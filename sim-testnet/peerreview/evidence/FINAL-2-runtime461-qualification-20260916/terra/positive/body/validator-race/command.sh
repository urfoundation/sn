...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/body/validator-race
source=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/workspace/sn
compiler=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/compile/validator-race
binary=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/compile/validator-race/validator.race.test
selector=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/body/validator-race/selector.txt
expected_tests=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/body/validator-race/expected-tests.txt
