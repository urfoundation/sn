...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/body/sim-testnet-race
source=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/workspace/sn
compiler=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/compile/sim-testnet-race
binary=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/compile/sim-testnet-race/sim-testnet.race.test
selector=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/body/sim-testnet-race/selector.txt
expected_tests=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/body/sim-testnet-race/expected-tests.txt
