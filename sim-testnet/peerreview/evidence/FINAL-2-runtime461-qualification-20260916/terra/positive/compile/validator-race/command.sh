...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/compile/validator-race
source=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/workspace/sn
selector=/mnt/data/sn-testnet/qualification/runtime461-20260916-r1/terra/positive/compile/validator-race/selector.txt
