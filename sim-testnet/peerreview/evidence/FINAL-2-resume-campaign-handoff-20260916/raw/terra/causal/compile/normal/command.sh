...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/terra/causal/compile/normal'
source_root='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/resume-without-campaign-handoff/workspace/sn'
work_root='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/resume-without-campaign-handoff/workspace'
expected_commit='2e6a8e435d4d3c49a9e5dc06e7093ce6870dcee0'
selector='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/terra/causal/inputs/selector.txt'
expected_tests='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/terra/causal/inputs/expected-tests.txt'
selection='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/selection.json'
variant='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/terra/causal/inputs/VARIANT.json'
binary='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/terra/causal/compile/normal/sim-testnet.normal.test'
race='false'
