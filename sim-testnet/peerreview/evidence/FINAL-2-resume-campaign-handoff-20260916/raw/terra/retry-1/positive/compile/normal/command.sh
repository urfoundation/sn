...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/terra/retry-1/positive/compile/normal'
...
variant=''
binary='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/terra/retry-1/positive/compile/normal/sim-testnet.normal.test'
race='false'
