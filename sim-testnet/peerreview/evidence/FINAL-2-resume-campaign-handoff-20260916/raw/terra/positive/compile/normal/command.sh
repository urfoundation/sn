...
set -u -o pipefail
umask 077
capture='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/terra/positive/compile/normal'
...
variant=''
binary='/mnt/data/sn-testnet/qualification/resume-campaign-handoff-20260916-r1/terra/positive/compile/normal/sim-testnet.normal.test'
race='false'
