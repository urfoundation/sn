#!/usr/bin/env bash
set -u -o pipefail
# Prepared relay-capture capture from the retained strict-resume owner.
# Requires a concrete REQUEST.json and late operands; preparation does not execute it.
umask 077
native_capture='/mnt/data/sn-testnet/qualification/native-recovery-20260916-r3/relay-capture-r3'
