...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/reserve-software-revision-20260916-r1/terra/correction-e639/normal/body
source=/mnt/data/sn-testnet/qualification/reserve-software-revision-20260916-r1/workspace/sn
compiler=/mnt/data/sn-testnet/qualification/reserve-software-revision-20260916-r1/terra/correction-e639/compile/normal
binary="/mnt/data/sn-testnet/qualification/reserve-software-revision-20260916-r1/terra/correction-e639/compile/normal/sim-testnet.correction.normal.test"
...
printf '%s\n' 'env GOMAXPROCS=4 GOCACHE=/mnt/data/sn-testnet/gocache TMPDIR=private GOTMPDIR=private timeout --foreground --kill-after=15s 600s go tool test2json -t sim-testnet.correction.normal.test -test.v -test.run=exact-union-selector -test.count=1 -test.timeout=10m -test.parallel=4' >"$capture/command.txt"
