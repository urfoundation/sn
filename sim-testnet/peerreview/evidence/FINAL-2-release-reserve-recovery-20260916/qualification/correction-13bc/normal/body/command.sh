...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/reserve-software-revision-20260916-r1/terra/correction-13bc/normal/body
source=/mnt/data/sn-testnet/qualification/reserve-software-revision-20260916-r1/workspace/sn
compiler=/mnt/data/sn-testnet/qualification/reserve-software-revision-20260916-r1/terra/correction-13bc/compile/normal
binary="/mnt/data/sn-testnet/qualification/reserve-software-revision-20260916-r1/terra/correction-13bc/compile/normal/sim-testnet.assertions.normal.test"
selector=/mnt/data/sn-testnet/qualification/reserve-software-revision-20260916-r1/terra/correction-13bc/confirmation.selector
expected_tests=/mnt/data/sn-testnet/qualification/reserve-software-revision-20260916-r1/terra/correction-13bc/confirmation.expected-tests.txt
expected=13bc2b3d4347c9940b983c6fdde3dd3bbf3e246b
status=125
...
printf '%s\n' 'env GOMAXPROCS=4 GOCACHE=/mnt/data/sn-testnet/gocache TMPDIR=private GOTMPDIR=private timeout --foreground --kill-after=15s 600s go tool test2json -t sim-testnet.assertions.normal.test -test.v -test.run=exact-union-selector -test.count=1 -test.timeout=10m -test.parallel=4' >"$capture/command.txt"
