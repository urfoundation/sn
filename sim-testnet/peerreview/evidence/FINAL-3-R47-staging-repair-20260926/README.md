...
`EPOCH-649-READINESS.json` pins the full-epoch source, its authenticated artifact identities, the exact six provisional low-usage shortfalls and the on-chain epoch states at the boundary.
