...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/runtime460-failed-root-retry-20260915-r1/terra/race/sim-testnet
source=/mnt/data/sn-testnet/qualification/runtime460-20260915-r1/metadata-constant-repair/workspace/sn
compiler=/mnt/data/sn-testnet/qualification/runtime460-failed-root-retry-20260915-r1/terra/compile/sim-testnet-race
binary="/mnt/data/sn-testnet/qualification/runtime460-failed-root-retry-20260915-r1/terra/compile/sim-testnet-race/sim-testnet.race.test"
selector=/mnt/data/sn-testnet/qualification/runtime460-failed-root-retry-20260915-r1/terra/selectors/sim-testnet.selector
expected_tests=/mnt/data/sn-testnet/qualification/runtime460-failed-root-retry-20260915-r1/terra/selectors/sim-testnet.expected-tests.txt
...
printf '%s\n' 'env GOMAXPROCS=4 GOCACHE=/mnt/data/sn-testnet/gocache TMPDIR=private GOTMPDIR=private timeout --foreground --kill-after=15s 600s go tool test2json -t sim-testnet.race.test -test.v -test.run=exact-union-selector -test.count=1 -test.timeout=10m -test.parallel=4' >"$capture/command.txt"
