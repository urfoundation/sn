...
set -u -o pipefail
umask 077
capture=/mnt/data/sn-testnet/qualification/runtime460-affected-matrix-20260915-r1/terra/race/sim-testnet
source=/mnt/data/sn-testnet/qualification/runtime460-20260915-r1/workspace/sn
compiler=/mnt/data/sn-testnet/qualification/runtime460-affected-matrix-20260915-r1/terra/compile/sim-testnet-race
binary="/mnt/data/sn-testnet/qualification/runtime460-affected-matrix-20260915-r1/terra/compile/sim-testnet-race/sim-testnet.race.test"
selector=/mnt/data/sn-testnet/qualification/runtime460-affected-matrix-20260915-r1/terra/selectors/sim-testnet.selector
expected_tests=/mnt/data/sn-testnet/qualification/runtime460-affected-matrix-20260915-r1/terra/selectors/sim-testnet.expected-tests.txt
