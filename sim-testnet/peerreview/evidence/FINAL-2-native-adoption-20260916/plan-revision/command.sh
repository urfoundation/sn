#!/usr/bin/env bash
set -u -o pipefail
# Prepared plan-revision capture from the retained strict-resume owner.
# Requires a concrete REQUEST.json and late operands; preparation does not execute it.
umask 077
native_capture='/mnt/data/sn-testnet/qualification/native-recovery-20260916-r2/plan-revision-after-reserve-recovery'
