...
**Preparation checkpoint, 2026-09-12 21:31 UTC.** The fleet and soak remain stopped. Actual read-only `doctor` on source `02dfe50` passed 63 of 64 checks; its sole failure was the user systemd manager's degraded state. All 43 failed units belonged to earlier stopped simulator jobs, with no main PID or cgroup. Their metadata and 621 available journal entries were preserved before clearing only those failure flags; systemd then reported `running`. No process was restarted. [Doctor result](../../temp/sn-full-finalization-20260912/readonly-admission-20260912/doctor.stdout.json), [preserved unit evidence hashes](../../temp/sn-full-finalization-20260912/readonly-admission-20260912/failed-unit-evidence.sha256), [manager state](../../temp/sn-full-finalization-20260912/readonly-admission-20260912/systemd-after.txt).

Three actual read-only `setup` attempts exposed successive migration blockers. Source `02dfe50` refused the full retained audit budget's `observed_at` field; `d282aba` accepted that signed document but refused the already successful repair activation without a verified journal marker. Source `9c444e4` authenticated and carried the exact repair transactions, then stopped at **`validator evidence plan has a different predecessor CREATE`** at 21:24:41 UTC. The combined binder derives the companion's predecessor from the later repaired coordinator, although the companion retains its original deployment identity. That composition fix remains pending. Each original error is preserved: [budget document](../../temp/sn-full-finalization-20260912/readonly-admission-20260912/setup.stderr), [transaction recovery](../../temp/sn-full-finalization-20260912/readonly-admission-20260912/setup-v2.stderr), [combined binding](../../temp/sn-full-finalization-20260912/readonly-admission-20260912/setup-v3.stderr). All three attempts emitted no revised plan; the original plan and journal still match their [retained hashes](../../temp/sn-full-finalization-20260912/readonly-admission-20260912/state-before.sha256). No new deployment, renewal, relay continuation, chain transaction or soak launch occurred during this preparation.

On candidate `9c444e4`, all five repair-carry roots and four relay-continuation roots have three fresh normal passes. The corrected offline authority root and all six archive roots also pass normally; remaining confirmations and race checks are still in progress. These results retain the original fixture failures and the real archive-copy defect that dropped its required canonical newline. [Repair carry](../../temp/sn-final-release-20260912/runtime-9c444e4-20260912T2118Z/sim.normal.carry.p3.stdout), [relay continuation](../../temp/sn-final-release-20260912/runtime-9c444e4-20260912T2118Z/sim.normal.relay.p3.stdout), [offline authority](../../temp/sn-final-release-20260912/runtime-9c444e4-20260912T2118Z/sim.normal.authority.p1.stdout), [archive replay](../../temp/sn-final-release-20260912/runtime-9c444e4-20260912T2118Z/validator.normal.archive-prior.p1.stdout). This candidate is pushed on `codex/sim-testnet-final-20260912`; it is not a full-release or live-acceptance pass.
