...
func TestReleaseSemanticCensusPinsCompleteRegressionSourceGroups(t *testing.T) {
	for _, group := range []struct {
		...
		{pattern: "final_semantic_fixture_dispatch_test.go", required: "^Test"},
		{pattern: "final_semantic_fixture_fleet_parallel_test.go", required: "^Test"},
		{pattern: "final_semantic_fixture_measurement_dependency_test.go", required: "^Test"},
		{pattern: "final_semantic_fixture_measurement_parallel_test.go", required: "^Test"},
		{pattern: "final_semantic_fixture_parallel_test.go", required: "^Test"},
		{pattern: "final_semantic_timeout_work_test.go", required: "^Test"},
		{pattern: "final_semantic_timeout_normalization_test.go", required: "^Test"},
		{pattern: "final_semantic_generation_reuse_test.go", required: "^Test"},
		{pattern: "final_semantic_generation_work_test.go", required: "^Test"},
		{pattern: "final_semantic_namespace_reuse_test.go", required: "^Test"},
		{pattern: "final_semantic_namespace_work_test.go", required: "^Test"},
		{pattern: "final_semantic_timeout_lineage_test.go", required: "^Test"},
