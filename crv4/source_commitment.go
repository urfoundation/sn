...
// Reviewed runtimes 454, 455, 458 and 459 use Utility.batch_all for exactly two calls
...
func reviewedSourceEncodingVersion(spec, transaction uint32) bool {
	return (spec == 454 || spec == 455 || spec == 458 || spec == 459) && transaction == 1
}

// This strict offline encoding is the audited 454/455/458/459 shape. Live metadata
